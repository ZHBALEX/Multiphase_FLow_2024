...
Time3 = data3.Time(:);  
CenterVelocity3 = data3.CenterVelocity(:);
...
idx3 = find(CenterVelocity3 ~= 0, 1, 'last');
Time3 = Time3(1:idx3);
CenterVelocity3 = CenterVelocity3(1:idx3);
...
Time3 = Time3(1:end-n);
CenterVelocity3 = CenterVelocity3(1:end-n);
...
plot(Time3, CenterVelocity3, 'Color', colors(3, :), ...
    'LineWidth', 2, 'LineStyle', lineStyles{3});
...
% 添加图例
legend({'Eo = 12', 'Eo = 24', 'Eo = 72'}, 'Location', 'Best');
